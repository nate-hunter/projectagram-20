    ...
    <List>
      {options.map((option, index) => (
        <ListItem
          ...
          classes={{
            seleceted: classes.listItemSelected,
    ...
    <section className={classes.container}>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className={classes.form}>
        ...
        <SectionItem 
          ...
          text="Username" formItem={user.username} error={error} />
        <SectionItem 
          name="website" 
          inputRef={register({
        ...
        <SectionItem 
          ...
          text="Email" formItem={user.email} type="email" error={error} />
        <SectionItem 
          name="phoneNumber"
          inputRef={register({
